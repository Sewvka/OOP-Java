...
import ru.nsu.fit.oop.snakegamefx.game.GameController;
import ru.nsu.fit.oop.snakegamefx.skin.Skin;
import ru.nsu.fit.oop.snakegamefx.sprite.BoardFX;
import ru.nsu.fit.oop.snakegamefx.sprite.FruitFX;
import ru.nsu.fit.oop.snakegamefx.sprite.SnakeFX;
import ru.nsu.fit.oop.snakegamefx.game.GameFX;
...
public class SnakeGame {
    ...
    private void setImages() {
        ...
        images.put("board", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/images/square.png").toExternalForm())));
        images.put("head", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/images/snake/head.png").toExternalForm())));
        images.put("rotated", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/images/snake/rotated.png").toExternalForm())));
        images.put("straight", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/images/snake/straight.png").toExternalForm())));
        images.put("tail", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/images/snake/tail.png").toExternalForm())));
        images.put("apple", new Image(String.valueOf(getClass().getResource("/ru/nsu/fit/oop/images/apple.png").toExternalForm())));
    }
    ...
    private void setScene() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ru/nsu/fit/oop/fxml/snakeGame.fxml"));
        try {
